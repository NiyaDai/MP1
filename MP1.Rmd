...
- `r standard_button("aesthetics")`: In terms of our data graphics, we firstly used the line chart to represent the correlation between the determinants of the diamonds and the price of the We met the Aesthetics standard because we...
